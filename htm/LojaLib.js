...
var sF$=(function(){
  ...
  function fnShowParcels(Price,iMaxParcels,ProductID){
    ...
    if(iMaxParcels>1 && Price>=1)sPrice+="<div class=\"installments\">ou <strong><span class=\"installment-count\">"+ iMaxParcels +"</span>x</strong> de <strong><span class=\"installment-price\">"+FormatPrecoReais(CalculaParcelaJurosCompostos(Price,iMaxParcels))+"</span></strong>"+ sInterest +"</div>";
...
function fnLoginUserName(NameUser){
  if("" != NameUser){
    jQuery('.loginInfo').html("<span class='col-small-12'>Olá, <b>"+NameUser+"</b>,</span> <span class='col-small-12'><a href='/cadastro.asp?IDLoja="+FC$.IDLoja+"&logoff=1' target='_top'><b>sair</b></a></span>");
  }
  else{jQuery('.loginInfo').html("<span class='col-small-12'>Olá, <b>visitante</b></span> <span class='hide-small'>|</span> <span class='col-small-12'>Faça seu <a href='/cadastro.asp?idloja="+FC$.IDLoja+"&pp=3&passo=1&sit=1'><b>Login</b></a></span>")}
}
...
function fnFooter(){
  ...
  if (FC$.Page=="Products" && ListVerify){
    document.querySelector('#idFCContent').setAttribute('class','col-large-10 col-xlarge-10');
  };
...
function ValidaCadNewsletter(email){
  alert(email);
